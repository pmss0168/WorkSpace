        ...
        <div>
            <table class="table table-bordered table-striped list">
                ...
                <tr class="item">
                    ...
                    <%if(u.getIsAdmin() == 0){%>
                    <td>
                        <form action="/Project_J2EE_NhaNghi/addAdmin" method="post">
                    ...
                    <%}else{%>
                    <td>
                        <form action="/Project_J2EE_NhaNghi/removeAdmin" method="post">
                            <input type="hidden"  name="username" value="<%=u.getUsername()%>"/>
                    ...
                    <%if(u.getIsStaff() == 0){%>
                    <td>
                        <form action="/Project_J2EE_NhaNghi/addStaff" method="post">
                            <input type="hidden"  name="username" value="<%=u.getUsername()%>"/>
                            <button type="submit" class="btn btn-primary">Thêm</button>
                        </form>
                    </td>
                    <%}else{%>
                    <td>
                        <form action="/Project_J2EE_NhaNghi/removeStaff" method="post">
                            <input type="hidden"  name="username" value="<%=u.getUsername()%>"/>
                            <button type="submit" class="btn btn-danger">Xóa</button>
                        </form>
                    </td>
