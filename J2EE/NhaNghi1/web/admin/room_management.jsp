...
<html>
    ...
    <body>
        ...
        <h2>Quản lý phòng</h2>
        <form action="/Project_J2EE_NhaNghi/addRoom" method="post">
        ...
        <table class="table table-bordered table-striped list">
            ...
            <tr class="item">
                ...
                <td><%=r.getCategory()%></td>
                <td>
                    <form action="/Project_J2EE_NhaNghi/removeRoom" method="post">
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="/Project_J2EE_NhaNghi/editRoom" method="post">
