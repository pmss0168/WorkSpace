...
public final class category_005fmanagement_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(user.getIsAdmin() == 0 && user.getIsStaff() == 0){
  ...
  if(user.getIsStaff() == 0 && user.getIsAdmin() == 0){
      ...
      out.write('\n');
      out.write("\n");
      out.write("        <h2>Quản lý loại phòng</h2>\n");
      out.write("        <form action=\"/Project_J2EE_NhaNghi/addCategory\" method=\"post\">\n");
      ...
      out.write("                        <h3 class=\"text-center\">Thêm loại phòng</h3>\n");
      out.write("                    </td>\n");
      out.write("                </tr>\n");
      out.write("                <tr>\n");
      out.write("                    <td class=\"text-center\">Loại phòng</td>\n");
      out.write("                    <td>\n");
      out.write("                        <input class=\"p-1\" style=\"width: 90%\" type=\"text\" name=\"name\" required>\n");
      out.write("                    </td>\n");
      out.write("                </tr>\n");
      out.write("                <tr>\n");
      out.write("                    <td class=\"text-center\">Giá phòng</td>\n");
      out.write("                    <td>\n");
      out.write("                        <input class=\"p-1\" style=\"width: 90%\" type=\"number\" name=\"price\" required>\n");
      out.write("                    </td>\n");
      out.write("                </tr>\n");
      out.write("                <tr>\n");
      ...
      out.write("                <th>Giá</th>\n");
      out.write("                <th>Xóa loại phòng</th>\n");
      out.write("                <th>Sửa loại phòng</th>\n");
      out.write("            </tr>\n");
      out.write("            ");
CategoryDao cd = new CategoryDao();
      ...
      out.write("                <td>");
      out.print(c.getIdcate());
      out.write("</td>\n");
      out.write("                <td>");
      out.print(c.getCate());
      out.write("</td>\n");
      out.write("                <td>");
      out.print(Util.formatToVND(c.getPrice()));
      out.write("</td>\n");
      out.write("                <td>\n");
      out.write("                    <form action=\"/Project_J2EE_NhaNghi/removeCategory\" method=\"post\">\n");
      ...
      out.write("                </td>\n");
      out.write("                <td>\n");
      out.write("                    <button type=\"button\" class=\"btn btn-primary\" data-bs-toggle=\"modal\" data-bs-target=\"#editCategoryForm\" data-bs-cate=\"");
      out.print(c.getCate());
      out.write("\" data-bs-whatever=\"");
      out.print(c.getIdcate());
      ...
      out.write("\n");
      out.write("        </table>\n");
      out.write("        <div class=\"modal fade\" id=\"editCategoryForm\" tabindex=\"-1\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n");
      out.write("            <div class=\"modal-dialog\">\n");
      out.write("                <div class=\"modal-content\">\n");
      out.write("                    <div class=\"modal-header bg-danger-subtle\">\n");
      out.write("                        <h1 class=\"modal-title fs-5\" id=\"exampleModalLabel\">Sửa loại phòng:</h1>\n");
      out.write("                        <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"modal\" aria-label=\"Close\"></button>\n");
      out.write("                    </div>\n");
      out.write("                    <form action=\"/Project_J2EE_NhaNghi/editCategory\" method=\"post\">\n");
      out.write("                        <div class=\"modal-body\">\n");
      out.write("                            <div class=\"mb-3\">\n");
      out.write("                                <label for=\"recipient-name\" class=\"col-form-label\">Loại phòng:</label>\n");
      out.write("                                <input name=\"category\" type=\"text\" class=\"form-control\" id=\"recipient-name\" required>\n");
      out.write("                                <input name=\"id\" type=\"hidden\" class=\"getId\">\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"mb-3\">\n");
      out.write("                                <label for=\"message-text\" class=\"col-form-label\">Giá phòng:</label>\n");
      out.write("                                <input name=\"price\" type=\"number\" class=\"form-control\" id=\"message-text\" required>\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
      ...
      out.write("\n");
      out.write("            <script>\n");
      out.write("            const editCategoryForm = document.getElementById('editCategoryForm');\n");
      out.write("            if (editCategoryForm) {\n");
      out.write("                editCategoryForm.addEventListener('show.bs.modal', event => {\n");
      ...
      out.write("                    const cate = button.getAttribute('data-bs-cate');\n");
      ...
      out.write("                    const modalTitle = editCategoryForm.querySelector('.modal-title');\n");
      out.write("                    const modalBodyInput = editCategoryForm.querySelector('.modal-body input');\n");
      out.write("                    const getId = editCategoryForm.querySelector('.modal-body .getId');\n");
      out.write("                    modalTitle.textContent = `Sửa loại phòng: ");
      ...
      out.write("`;\n");
      out.write("                    modalBodyInput.value = cate;\n");
      out.write("                    getId.value = recipient;\n");
      out.write("                });\n");
      out.write("            }\n");
      out.write("        </script>\n");
      out.write("        ");
