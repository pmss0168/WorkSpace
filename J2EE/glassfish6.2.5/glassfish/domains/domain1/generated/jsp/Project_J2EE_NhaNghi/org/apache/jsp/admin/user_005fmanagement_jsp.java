...
if(user.getIsAdmin() == 0 && user.getIsStaff() == 0){
  ...
  if(user.getIsStaff() == 0 && user.getIsAdmin() == 0){
      ...
      out.write("                    <th>Thêm/xóa admin</th>\n");
      out.write("                    <th>Thêm/xóa nhân viên</th>\n");
      out.write("                </tr>\n");
      out.write("                ");
UserDao ud = new UserDao();
      ...
      out.write("</td>\n");
      out.write("                    <td>");
      out.print(u.getIsStaff());
      out.write("</td>\n");
      out.write("                    ");
if(u.getIsAdmin() == 0){
      out.write("\n");
      out.write("                    <td>\n");
      out.write("                        <form action=\"/Project_J2EE_NhaNghi/addAdmin\" method=\"post\">\n");
      ...
      out.write("\n");
      out.write("                    <td>\n");
      out.write("                        <form action=\"/Project_J2EE_NhaNghi/removeAdmin\" method=\"post\">\n");
      out.write("                            <input type=\"hidden\"  name=\"username\" value=\"");
      out.print(u.getUsername());
      out.write("\"/>\n");
...
if(u.getIsStaff() == 0){
      out.write("\n");
      out.write("                    <td>\n");
      out.write("                        <form action=\"/Project_J2EE_NhaNghi/addStaff\" method=\"post\">\n");
      out.write("                            <input type=\"hidden\"  name=\"username\" value=\"");
      out.print(u.getUsername());
      out.write("\"/>\n");
      out.write("                            <button type=\"submit\" class=\"btn btn-primary\">Thêm</button>\n");
      ...
      out.write("\n");
      out.write("                    <td>\n");
      out.write("                        <form action=\"/Project_J2EE_NhaNghi/removeStaff\" method=\"post\">\n");
      out.write("                            <input type=\"hidden\"  name=\"username\" value=\"");
      out.print(u.getUsername());
      out.write("\"/>\n");
      out.write("                            <button type=\"submit\" class=\"btn btn-danger\">Xóa</button>\n");
