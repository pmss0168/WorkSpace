...
if(user.getIsAdmin() == 0 && user.getIsStaff() == 0){
  ...
  if(user != null){
      ...
      out.write("        <div class=\"list\" style=\"display: flex; justify-content: center; flex-wrap: wrap; gap: 20px; padding: 10px;\">\n");
      out.write("            ");
BookingDao bd = new BookingDao();
      ...
      out.write("\n");
      out.write("            <form class=\"item\" action=\"/cancelBill\" method=\"post\">\n");
      out.write("                <div style=\"padding: 20px; border: 1px solid rgba(0,0,0,0.3); width: 350px;\">\n");
...
if(b.getIsCancel() == 1){
      ...
      out.write("                    <input class=\"btn btn-danger\" type=\"submit\" value=\"Hủy đặt\" disabled/>\n");
      out.write("                    ");
      ...
      out.write("\n");
      out.write("                    <p class=\"p-3 text-primary-emphasis bg-primary-subtle border border-primary-subtle rounded-3\" style=\"color: #1da1f2\">Đã xác nhận</p>\n");
      out.write("                    <input class=\"btn btn-danger\" type=\"submit\" value=\"Hủy đặt\" disabled/>\n");
      out.write("                    ");
}else if(b.getIsCancel() == 0 && b.getIsSuccess() == 0 && b.getIsConfirm() == 0){
      out.write("\n");
      out.write("                    <p class=\"p-3 text-info-emphasis bg-info-subtle border border-info-subtle rounded-3\" style=\"color: #1da1f2\">Đặt phòng thành công</p>\n");
      out.write("                    <input class=\"btn btn-danger\" type=\"submit\" value=\"Hủy đặt\"/>\n");
      out.write("                    ");
}
      out.write("\n");
