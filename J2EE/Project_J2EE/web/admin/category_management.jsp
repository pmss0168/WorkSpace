...
<html>
    ...
    <body>
        ...
        <form action="/Project_J2EE_NhaNghi/addCategory" method="post">
        ...
        <table class="table table-bordered table-striped list">
            ...
            <tr class="item">
                ...
                <td>
                    <form action="/Project_J2EE_NhaNghi/removeCategory" method="post">
        ...
        <div class="modal fade" id="editCategoryForm" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="/Project_J2EE_NhaNghi/editCategory" method="post">
